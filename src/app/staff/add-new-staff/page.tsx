...
const AddNewStaff = () => {
  ...
  return (
    <MainLayout
      ...
      label="View, search for and add new staff"
      title=" All Staff"
    >
                ...
                <div className={styles.inputContainer}>
                  ...
                  <label htmlFor="file" className={styles.inputLabelContainer}>
                    <div className={styles.inputLabelInner}>
                      <img
                        className={selectedFile ? styles.image : styles.dNone}
                        src={
                          selectedFile
                      ...
                      <div
                        className={
                          selectedFile ? styles.indexZ : styles.photoFrameText
                        }
                      >
                        <AddPhotoIcon />
                        <span>
                  ...
                  <div className={styles.inputDescription}>
                    <span className={styles.inputDescriptionTitle}>
                      Allowed format
                    </span>
                    <span className={styles.inputDescriptionText}>
                      JPG, JPEG, and PNG
                    </span>
                  </div>
                  <div className={styles.inputDescription}>
