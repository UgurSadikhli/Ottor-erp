    ...
    return (
        <AuthLayout imageUrl="/assets/auth/img2.jpeg">
            <div className={`${styles.mainContainer} d-flex flex-column`}>
                ...
                <div className={`${styles.seventyFiveToHundredContainer}d-flex mt-5 flex-column align-items-start justify-content-around`}>
                    <p className={`${styles.minorText}`}>2FA</p>
                    <h3 className={`${styles.mainText}`}>Please enter the 2FA code sent to your mail.</h3>
                </div>

                <div className={`${styles.seventyFiveToHundredContainer} d-flex mt-3 flex-column align-items-start justify-content-around`}>
                ...
                <div className="mt-3 w-100">
                    <button onClick={handleSubmit} type="submit" className={`${styles.customButton} btn btn-primary w-75 mt-4`}>Verify</button>
                </div>
