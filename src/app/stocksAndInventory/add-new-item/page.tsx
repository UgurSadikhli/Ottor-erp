...
const AddNewItem = () => {
    ...
    return (
        <MainLayout icon={<SrockAndInventoryHeaderIcon/>} title="Update Stock" label="Add new item to stocks">
            <div className={styles.main}>
                <div className={styles.top}>
                    <CustomButton icon={<ArrowRightIcon color="black"/>} links="stocksAndInventory" label="Back"/>
                </div>
